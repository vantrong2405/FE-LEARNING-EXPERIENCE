  ...
  return (
    <div className='bg-gray-900 py-16 md:py-24'>
      <div className='container mx-auto px-4'>
        <h2 className='text-3xl md:text-4xl font-bold mb-4 text-center text-white animate-fade-in-up'>
          Featured Course Bundles
        </h2>
        <p className='text-gray-400 mb-12 text-center max-w-2xl mx-auto text-lg animate-fade-in-up animation-delay-150'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
          {courses.map((course, index) => (
            <div key={index} className='animate-fade-in-up' style={{ animationDelay: `${index * 100}ms` }}>
              <Card className='bg-gray-800 border-gray-700 overflow-hidden transform hover:scale-105 transition-transform duration-300'>
