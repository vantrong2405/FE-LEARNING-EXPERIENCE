...
export function CoursesBarChart() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Xếp hạng khóa học</CardTitle>
        <CardDescription>Được đặt nhiều nhất</CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer config={chartConfig}>
          ...
          >
            ...
            <Bar dataKey='successOrders' name={'Đơn hàng'} layout='vertical' radius={5} />
          </BarChart>
        </ChartContainer>
      </CardContent>
